...
MODULES.legalCompliance = {
  ...
  diagnosticQuestions:[
    ...
    {q:'Under the Data Protection Act 1998, which body is responsible for enforcing data protection law and has the power to investigate breaches and issue fines?',opts:['The National Crime Agency — which handles serious organised crime','The Information Commissioner\'s Office (ICO) — the independent supervisory authority for data protection in the UK','The Home Office — which oversees all privacy and security legislation'],ok:1,hint:'The ICO enforces the DPA 1998. It can conduct audits, issue enforcement notices, and impose fines for serious breaches.'},
